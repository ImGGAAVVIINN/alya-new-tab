window.loadAutoHideModule = function(e) {
    ...
    $("#enable_autohide").on("change", function() {
        var isChecked = $("#enable_autohide").is(":checked");
        localStorage.setItem("enable_autohide", isChecked ? "yes" : "no");
        updateAutoHideState();
    ...
    $("#autohide_timeout").on("change", function() {
        localStorage.setItem('autohide_timeout', $("#autohide_timeout").val());
        updateAutoHideState();
    });
};
...
window.stopFireworksCanvas = function() {
    ...
    window.pausedAnimation = false;
    if (localStorage.getItem("enable_snow") == "yes" && localStorage.getItem("snow_type") == "rain")
        startRainCanvas()
}
;
window.startFireworksCanvas = function() {
    ...
    if (localStorage.getItem("snow_type") == "rain")
        stopRainCanvas();
    var e = document.getElementById("fireworks-canvas");
    if (e)
        e.parentNode.removeChild(e);
